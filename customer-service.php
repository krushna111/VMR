                    ...
                    <div>
                        <div class="vmr-color-blue-dark">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#customer-service" data-toggle="tab"
                                        aria-expanded="false">Customer Service</a></li>
                                <li class=""><a href="#faqs" data-toggle="tab" aria-expanded="true">FAQs</a></li>
                                <li class=""><a href="#research-specialists" data-toggle="tab"
                                        aria-expanded="false">Research Specialists</a></li>
                            </ul>
                            <div class="tab-content">
                                <div id="customer-service" class="tab-pane active fade in">
