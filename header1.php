...
<head>
	...
	<title>About Us | Verified Market Research® | Market Research Reports</title><link rel="preload" as="style" href="https://fonts.googleapis.com/css?family=Work%20Sans%3A700%2C300%2C400%2C500%7COpen%20Sans%3A300%2C400%7CRoboto%3A500%2C300&amp;display=swap"><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Work%20Sans%3A700%2C300%2C400%2C500%7COpen%20Sans%3A300%2C400%7CRoboto%3A500%2C300&amp;display=swap" media="all" onload="this.media='all'"><noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Work%20Sans%3A700%2C300%2C400%2C500%7COpen%20Sans%3A300%2C400%7CRoboto%3A500%2C300&#038;display=swap" /></noscript>
	<meta name="description" content="Browse for Research Reports, latest information and in-depth analysis of markets. Find Market Research Data and Industry Analysis in line with latest trends">
	<link rel="canonical" href="<?=HOST?>about-us/">
	<meta property="og:locale" content="en_US">
	<meta property="og:type" content="article">
	<meta property="og:title" content="About Us | Verified Market Research® | Market Research Reports">
	<meta property="og:description" content="Browse for Research Reports, latest information and in-depth analysis of markets. Find Market Research Data and Industry Analysis in line with latest trends">
	<meta property="og:url" content="<?=HOST?>about-us/">
	...
	<meta property="article:modified_time" content="2024-12-09T04:31:45+00:00">
...
<header id="masthead" class="sticky-top site-header navbar-static-top navbar-light" role="banner">
       <section id="SearchBar"><div class="container"><div data-load="no" class="search_wrapper text-right HeaderSearch" id="vmr-header-search-wrap" style="display: none">
        <form method="get" id="vmr-header-search-form" action="<?=HOST?>reports/"><div class="row"><div class="col-md-2 SearchText pl-0 text-left"><p class="pt-1 m-0 vmr-font20 vmr-color-white">Search Markets</p></div><div class="col-md-9 position-relative"><div class="ais-search-box"><input name="key" class="form-control ais-search-box--input" type="text" placeholder="Search Report" id="searchbox" autocomplete="off" autocapitalize="off" autocorrect="off" role="textbox" spellcheck="false" value=""></div><div class="search-dropdown" id="hits-container"></div><input type="submit" class="submit" value="<i class=\'icon-search-fine\'></i>" style="display:none;"><button style="display:none;" class="submit home-srch-btn" type="submit"><i class="icon-search-fine"></i></button><button style="" class="submit home-srch-btn" type="submit"><img width="30" height="30" class="fa-flip-horizontal" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2030%2030'%3E%3C/svg%3E" data-lazy-src="<?=HOST?>images/search-icon1.png"><noscript><img width="30" height="30" class="fa-flip-horizontal" src="<?=HOST?>images/search-icon1.png"></noscript></button><div class="loader fliter_loader HomeSearchSpinner" style="display: none;"></div></div><div class="col-md-1"> <a href="#" class="icon_close"><i class="fa fa-times"></i></a> </div></div><div class="row"><div class="offset-md-2 col-md-9"><div class="AutoSearch rounded-bottom"></div></div></div></form>
       </div></div></section>
        <div class="container">
            <nav class="navbar navbar-expand-lg p-0">
                <div class="navbar-brand">
                                            <a href="<?=HOST?>">
                                                    <img class="vmr-site-logo entered lazyloaded" src="<?=HOST?>images/vmr-logo-desktop.png" alt="Verified Market Research" width="206" height="70" data-lazy-src="<?=HOST?>images/vmr-logo-desktop.png" data-ll-status="loaded"><noscript><img class="vmr-site-logo" src="<?=HOST?>images/vmr-logo-desktop.png" alt="Verified Market Research" width="206" height="70"></noscript>
                                                </a>
                ...
                <div id="main-nav" class="collapse navbar-collapse justify-content-end"><ul id="menu-main-menu" class="navbar-nav"><li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121149" class="report-store ee menu-item menu-item-type-post_type menu-item-object-page menu-item-121149 nav-item"><a title="Report Store " href="<?=HOST?>report-store/" class="nav-link">Report Store <i class="fa fa-caret-down"></i></a></li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-78326" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-77372 current_page_item active menu-item-78326 nav-item"><a title="VM Intelligence" href="<?=HOST?>vmintelligence/" class="nav-link" aria-current="page">VM Intelligence</a></li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-271941" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-271941 nav-item"><a title="Consulting " href="<?=HOST?>consulting/" aria-haspopup="flase" aria-expanded="false" class="dropdown-toggle nav-link" id="menu-item-dropdown-271941">Consulting <i class="fa fa-caret-down"></i></a>
<ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-271941" role="menu">
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-271993" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-271993 nav-item"><a title="Market Plan" href="<?=HOST?>consulting-market-plan/" class="dropdown-item">Market Plan</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-271992" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-271992 nav-item"><a title="Go-To-Market Strategy" href="<?=HOST?>consulting-market-strategy/" class="dropdown-item">Go-To-Market Strategy</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-271994" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-271994 nav-item"><a title="VMR Business Benchmarking" href="<?=HOST?>consulting-vmr-business-benchmarking/" class="dropdown-item">VMR Business Benchmarking</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-271995" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-271995 nav-item"><a title="Customer Insights" href="<?=HOST?>consulting-customer-insights/" class="dropdown-item">Customer Insights</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-271996" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-271996 nav-item"><a title="Competitive Insights" href="<?=HOST?>consulting-competitive-insights/" class="dropdown-item">Competitive Insights</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-271997" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-271997 nav-item"><a title="Vendor Management" href="<?=HOST?>consulting-vendor-management/" class="dropdown-item">Vendor Management</a></li>
</ul>
</li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-6056" class="vmr-mega-menu mega_menu_hover_bg menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-6056 nav-item"><a title="Industries We Cover " href="#" aria-haspopup="flase" aria-expanded="false" class="dropdown-toggle nav-link" id="menu-item-dropdown-6056">Industries We Cover <i class="fa fa-caret-down"></i></a>
<ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-6056" role="menu">
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121151" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121151 nav-item"><a title="Aerospace &amp; Defence" href="<?=HOST?>aerospace-defense-industry/" class="dropdown-item">Aerospace &amp; Defence</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121152" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121152 nav-item"><a title="Agriculture" href="<?=HOST?>agri-food-industry/" class="dropdown-item">Agriculture</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121904" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121904 nav-item"><a title="Food &amp; Beverages Industry" href="<?=HOST?>food-beverages/" class="dropdown-item">Food &amp; Beverages Industry</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121153" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121153 nav-item"><a title="Automobile &amp; Transportation" href="<?=HOST?>automotive-industry/" class="dropdown-item">Automobile &amp; Transportation</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121154" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121154 nav-item"><a title="Chemical &amp; Material" href="<?=HOST?>chemical-basic-materials-industry/" class="dropdown-item">Chemical &amp; Material</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121157" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121157 nav-item"><a title="Consumer Goods" href="<?=HOST?>consumer-goods-retail-industry/" class="dropdown-item">Consumer Goods</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121903" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121903 nav-item"><a title="Retail &amp; eCommerce" href="<?=HOST?>retail-ecommerce/" class="dropdown-item">Retail &amp; eCommerce</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121159" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121159 nav-item"><a title="Energy &amp; Power" href="<?=HOST?>energy-industry/" class="dropdown-item">Energy &amp; Power</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121160" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121160 nav-item"><a title="Pharma &amp; Healthcare" href="<?=HOST?>healthcare-industry/" class="dropdown-item">Pharma &amp; Healthcare</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121161" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121161 nav-item"><a title="Packaging, Construction, Mining &amp; Gases" href="<?=HOST?>manufacturing-construction-industry/" class="dropdown-item">Packaging, Construction, Mining &amp; Gases</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121163" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121163 nav-item"><a title="Electronics &amp; Semiconductor" href="<?=HOST?>semiconductor-industry/" class="dropdown-item">Electronics &amp; Semiconductor</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121164" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121164 nav-item"><a title="Banking Financial Services &amp; Insurance Industry" href="<?=HOST?>services-industry/" class="dropdown-item">Banking Financial Services &amp; Insurance Industry</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121165" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121165 nav-item"><a title="Internet, Communication, Software &amp; Services" href="<?=HOST?>technology-industry/" class="dropdown-item">Internet, Communication, Software &amp; Services</a></li>
</ul>
</li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121167" class="mega_menu_hover_bg resources_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-121167 nav-item"><a title="Resources " href="#" aria-haspopup="flase" aria-expanded="false" class="dropdown-toggle nav-link" id="menu-item-dropdown-121167">Resources <i class="fa fa-caret-down"></i></a>
<ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-121167" role="menu">
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121169" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121169 nav-item"><a title="Blog" href="<?=HOST?>blog/" class="dropdown-item">Blog</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-384645" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-384645 nav-item"><a title="Media mentions" href="<?=HOST?>media-mentions/" class="dropdown-item">Media mentions</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-137647" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-137647 nav-item"><a title="Press Release" href="<?=HOST?>pressrelease/" class="dropdown-item">Press Release</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-31573" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-31573 nav-item"><a title="Infographics" href="<?=HOST?>report-infographics/" class="dropdown-item">Infographics</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-177619" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-177619 nav-item"><a title="Inspire Research" href="<?=HOST?>understand-research/" class="dropdown-item">Inspire Research</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-177634" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-177634 nav-item"><a title="Research Methodology" href="<?=HOST?>research-methodology/" class="dropdown-item">Research Methodology</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-194050" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-194050 nav-item"><a title="Customer Testimonials" href="<?=HOST?>customer-testimonials/" class="dropdown-item">Customer Testimonials</a></li>
	<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-406012" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-406012 nav-item"><a title="Market Research Glossary" href="<?=HOST?>marketresearchglossary/" class="dropdown-item">Market Research Glossary</a></li>
</ul>
</li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-127353" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-127353 nav-item"><a title="About" href="<?=HOST?>about-us/" class="nav-link">About</a></li>
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1011" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1011 nav-item"><a title="Contact" href="<?=HOST?>contact-us/" class="nav-link">Contact</a></li>
...
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-121172" class="vmr-header-search menu-item menu-item-type-custom menu-item-object-custom menu-item-121172 nav-item"><a href="#" class="nav-link"><i class="fa fa-search"></i></a></li>
</ul></div>            </nav>
      ...
      <div class="mega-menu-wrap close_btn_parrent">
         <img class="close_header" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2017%2017'%3E%3C/svg%3E" width="17" height="17" style="filter: invert(97%) sepia(3%) saturate(0%) hue-rotate(334deg) brightness(201%) contrast(103%);" data-lazy-src="<?=HOST?>images/CloseCopy.png"><noscript><img class="close_header" src="<?=HOST?>images/CloseCopy.png" width="17" height="17" style="filter: invert(97%) sepia(3%) saturate(0%) hue-rotate(334deg) brightness(201%) contrast(103%);"></noscript>
         <div class="row">
            <!-- first row -->
            <div class="col-md-4 p-0">
               <div class="industry p-0">
                  <ul class="stander mb-0">
                     <li>                     
                        <a class="tablinks tablinks_hover1 AllReport" href="<?=HOST?>report-store">
                          Report Store
                        </a>
                     </li>
                      
                       <li>
                        <a class="tablinks tablinks_hover1 active" href="<?=HOST?>rcategory/aerospace-defence/" onmouseover="opentab(event, 'tab_id0','tab_content0')">
                          <div>
                            <img src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2020%2020'%3E%3C/svg%3E" class="" width="20" height="20" data-lazy-src="https://images.verifiedmarketresearch.com/assets/Aerospace-2.png"><noscript><img src="https://images.verifiedmarketresearch.com/assets/Aerospace-2.png" class="" width="20" height="20"></noscript> 
                          </div>
                       ...
                       <li>
                        <a class="tablinks tablinks_hover1 " href="<?=HOST?>rcategory/banking-financial-services-insurance-2/" onmouseover="opentab(event, 'tab_id3','tab_content3')">
                          <div>
                            <img src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2020%2020'%3E%3C/svg%3E" class="" width="20" height="20" data-lazy-src="<?=HOST?>images/star.png"><noscript><img src="<?=HOST?>images/star.png" class="" width="20" height="20"></noscript> 
                          </div>
